# - Config file for the gz-waves-hydrodynamics-system component
#
# This should only be invoked by gz-waves-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-waves COMPONENTS hydrodynamics-system)
#
# This creates the following targets:
#
#   Component library target                - gz-waves::gz-waves-hydrodynamics-system
#   Alternative target name                 - gz-waves::hydrodynamics-system
...
# this is discouraged:
#
#   gz-waves-hydrodynamics-system_LIBRARY  - Component library (actually contains gz-waves::hydrodynamics-system)
#
# We will also set gz-waves-hydrodynamics-system_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-waves-hydrodynamics-system_CONFIG_INCLUDED)
  return()
endif()
set(gz-waves-hydrodynamics-system_CONFIG_INCLUDED TRUE)

if(NOT gz-waves-hydrodynamics-system_FIND_QUIETLY)
  message(STATUS "Looking for gz-waves-hydrodynamics-system -- found version 1.0.0")
endif()
...
# dependencies.
if(gz-waves-hydrodynamics-system_FIND_REQUIRED)
...
# dependencies.
if(gz-waves-hydrodynamics-system_FIND_QUIETLY)
...
if(NOT gz-waves-hydrodynamics-system_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-waves-hydrodynamics-system")
endif()

# --------------------------------

if(NOT TARGET gz-waves::gz-waves-hydrodynamics-system)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-waves-hydrodynamics-system-targets.cmake")
  ...
  add_library(gz-waves::hydrodynamics-system INTERFACE IMPORTED)
  set_target_properties(gz-waves::hydrodynamics-system PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-waves::gz-waves-hydrodynamics-system")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-waves::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-waves::gz-waves-hydrodynamics-system")
endif()

set(gz-waves-hydrodynamics-system_LIBRARY gz-waves::gz-waves-hydrodynamics-system)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-waves-hydrodynamics-system "gz-waves-hydrodynamics-system")
