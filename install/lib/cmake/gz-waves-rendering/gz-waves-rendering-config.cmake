# - Config file for the gz-waves-rendering component
#
# This should only be invoked by gz-waves-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-waves COMPONENTS rendering)
#
# This creates the following targets:
#
#   Component library target                - gz-waves::gz-waves-rendering
#   Alternative target name                 - gz-waves::rendering
...
# this is discouraged:
#
#   gz-waves-rendering_LIBRARY  - Component library (actually contains gz-waves::rendering)
#
# We will also set gz-waves-rendering_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-waves-rendering_CONFIG_INCLUDED)
  return()
endif()
set(gz-waves-rendering_CONFIG_INCLUDED TRUE)

if(NOT gz-waves-rendering_FIND_QUIETLY)
  message(STATUS "Looking for gz-waves-rendering -- found version 1.0.0")
endif()
...
# dependencies.
if(gz-waves-rendering_FIND_REQUIRED)
...
# dependencies.
if(gz-waves-rendering_FIND_QUIETLY)
...
if(NOT gz-waves-rendering_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-waves-rendering")
endif()
...
if(NOT TARGET gz-waves::gz-waves-rendering)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-waves-rendering-targets.cmake")
  ...
  add_library(gz-waves::rendering INTERFACE IMPORTED)
  set_target_properties(gz-waves::rendering PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-waves::gz-waves-rendering")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-waves::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-waves::gz-waves-rendering")
endif()

set(gz-waves-rendering_LIBRARY gz-waves::gz-waves-rendering)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-waves-rendering "gz-waves-rendering")
